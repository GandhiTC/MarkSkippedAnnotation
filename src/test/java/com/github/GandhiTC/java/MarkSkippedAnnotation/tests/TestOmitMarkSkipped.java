...
public class TestOmitMarkSkipped
{
	@Test(priority=1)
	@MarkSkipped(dependentMethods={"method3"})
	public void method1()
	{
		System.out.println("method1 = I will be manually omitted.  You should not be able to read this.");
	}
	...
	public void method3()
	{
		System.out.println("method3 = I will be automatically omitted.  You should not be able to read this.");
	}
}